...
def requester(url, data, headers, GET, delay, proxies):
    ...
    if GET:
        response = requests.get(url, params=data, headers=headers, verify=False, proxies=proxies)
        ...
        response = requests.post(url, data=data, headers=headers, verify=False, proxies=proxies)
    return response
